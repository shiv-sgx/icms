...
-- Users (demo password applied to all via __PWHASH__). Login usernames are kept
-- stable; only display names / emails are localized to US.
INSERT INTO users (id, full_name, email, username, password_hash, role_id, branch, status) VALUES
 ...
 (2,'Michael Anderson','michael.anderson@icms.local','manager','__PWHASH__',4,'New York','ACTIVE'),
 (3,'Jennifer Martinez','jennifer.martinez@icms.local','agent','__PWHASH__',2,'New York','ACTIVE'),
 (4,'Sarah Thompson','sarah.thompson@icms.local','sunita','__PWHASH__',2,'Chicago','ACTIVE'),
 (5,'David Wilson','david.wilson@icms.local','surveyor','__PWHASH__',3,'New York','ACTIVE'),
 (6,'Robert Garcia','robert.garcia@icms.local','vinod','__PWHASH__',3,'Chicago','ACTIVE'),
 (7,'James Miller','james.miller@example.com','customer','__PWHASH__',1,NULL,'ACTIVE'),
 (8,'Emily Davis','emily.davis@example.com','meera','__PWHASH__',1,NULL,'ACTIVE');

-- Policyholders (ids 1 & 2 mirror the two customer logins above by email)
